...
fn test_your_order() {
    ...
    // let (name, year, made_by_phone, made_by_mobile, made_by_email, item_number, count) = (order_template.name, order_template.year, order_template.made_by_phone, order_template.made_by_mobile, order_template.made_by_email,order_template.item_number, order_template.count);
